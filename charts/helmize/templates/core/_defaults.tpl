...
*/}}
{{- define "helmize.core.defaults.file_cfg.identifier" -}}
id
{{- end -}}
...
*/}}
{{- define "helmize.core.defaults.file_cfg.no_match" -}}
no_match
{{- end -}}


{{- define "helmize.core.defaults.file_cfg.subpath" -}}
subpath
{{- end -}}


{{- define "helmize.core.defaults.file_cfg.max_match" -}}
max_match
{{- end -}}
...
*/}}
{{- define "helmize.core.defaults.file_cfg.render" -}}
render
{{- end -}}
...
*/}}
{{- define "helmize.core.defaults.file_cfg.fork" -}}
fork
{{- end -}}
...
*/}}
{{- define "helmize.core.defaults.file_cfg.pattern" -}}
pattern
{{- end -}}
